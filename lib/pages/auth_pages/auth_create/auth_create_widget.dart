...
class _AuthCreateWidgetState extends State<AuthCreateWidget>
  ...
  void initState() {
    ...
    _model.addressInputController ??= TextEditingController();
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '6pykb9t5' /* Use the form below to get star... */,
                                  ),
                                  style:
                                ...
                                children: [
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.addressInputController,
                                        focusNode: _model.addressInputFocusNode,
                                        onFieldSubmitted: (_) async {
                                          logFirebaseEvent(
                                              'AUTH_CREATE_addressInput_ON_TEXTFIELD_SU');
                                          logFirebaseEvent(
                                              'addressInput_update_app_state');
                                          FFAppState().userAddress = _model
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'uwa2h99a' /* Enter your address here... */,
                                          ),
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium,
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        'xwv5ma30' /* Confirm Password */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'citfyb8l' /* Create your password... */,
                                      ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'dyom2b6w' /* Use a social platform to conti... */,
                                      ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'q73d2f76' /* Already have an account? */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ),
