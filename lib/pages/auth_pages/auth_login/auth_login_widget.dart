                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'gg063s62' /* Use the form below to access y... */,
                                ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          '3n2w8fq9' /* Email Address */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '2yd3xdiq' /* Enter your email here... */,
                                        ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'cs2c4y76' /* Enter your password here... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                        enabledBorder: OutlineInputBorder(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  AutoSizeText(
                                    FFLocalizations.of(context).getText(
                                      'nfw60hr0' /* Use a social platform to conti... */,
                                    ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '7fqkkd5g' /* Don't have an account? */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
