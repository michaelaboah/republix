...
class CreateCandidateWidget extends StatefulWidget {
  ...
  @override
  _CreateCandidateWidgetState createState() => _CreateCandidateWidgetState();
}
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.authCode != null && _model.authCode != '') {
        ...
        logFirebaseEvent('createCandidate_backend_call');
      } else {
        return;
      }

      // Enable Next Button
      logFirebaseEvent('createCandidate_EnableNextButton');
    });
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREATE_CANDIDATE_UploadHeadshotBtn_ON_TA');
                                          logFirebaseEvent(
                                              'UploadHeadshotBtn_upload_media_to_fireba');
                                          final selectedMedia =
                                              await selectMedia(
                                            mediaSource:
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREATE_CANDIDATE_UploadBannerBtn_ON_TAP');
                                          logFirebaseEvent(
                                              'UploadBannerBtn_upload_media_to_firebase');
                                          final selectedMedia =
                                              await selectMedia(
                                            mediaSource:
                                                MediaSource.photoGallery,
