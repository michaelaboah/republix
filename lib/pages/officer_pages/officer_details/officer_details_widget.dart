...
class OfficerDetailsWidget extends StatefulWidget {
...
class _OfficerDetailsWidgetState extends State<OfficerDetailsWidget>
  ...
  late OfficerDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfficerDetailsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'officerDetails'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('OFFICER_DETAILS_officerDetails_ON_INIT_S');
      logFirebaseEvent('officerDetails_update_page_state');
      setState(() {
        _model.isFollowing = (currentUserDocument?.following.toList() ?? [])
            .contains(widget.officerRef);
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<OfficialsRecord>(
      stream: OfficialsRecord.getDocument(widget.officerRef!),
      builder: (context, snapshot) {
        ...
        final officerDetailsOfficialsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          body: Visibility(
                        ...
                        children: [
                            ...
                            child: Stack(
                              children: [
                                Align(
                                  alignment: const AlignmentDirectional(0.0, -1.0),
                                  child: Image.network(
                                    officerDetailsOfficialsRecord.bannerImgUrl,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (officerDetailsOfficialsRecord.socialMedia
                                    .hasFacebookUrl())
                                  InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'OFFICER_DETAILS_Container_nrng8zx5_ON_TA');
                                      logFirebaseEvent(
                                ...
                                if (officerDetailsOfficialsRecord.socialMedia
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'OFFICER_DETAILS_Container_ak4p8hd7_ON_TA');
                                        logFirebaseEvent(
                                            'Container_launch_u_r_l');
                                        await launchURL(
                                            officerDetailsOfficialsRecord
                                ...
                                if (officerDetailsOfficialsRecord.socialMedia
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'OFFICER_DETAILS_Container_vtpey6gt_ON_TA');
                                        logFirebaseEvent(
                                            'Container_launch_u_r_l');
                                        await launchURL(
                                            officerDetailsOfficialsRecord
                                ...
                                if (officerDetailsOfficialsRecord.socialMedia
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'OFFICER_DETAILS_Container_a41qk159_ON_TA');
                                        logFirebaseEvent(
                                            'Container_launch_u_r_l');
                                        await launchURL(
                                            officerDetailsOfficialsRecord
                                ...
                                if (officerDetailsOfficialsRecord.socialMedia
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'OFFICER_DETAILS_Container_4y65zipg_ON_TA');
                                        logFirebaseEvent(
                                            'Container_launch_u_r_l');
                                        await launchURL(
                                            officerDetailsOfficialsRecord
                        ...
                        children: [
                          Expanded(
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'OFFICER_DETAILS_DONATE_TO_CANDIDATE_BTN_');
