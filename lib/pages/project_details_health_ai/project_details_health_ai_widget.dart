                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '5lo6vg43' /* Client Acquisition for Q3 */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ).animateOnPageLoad(animationsMap[
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'tb86mcgy' /* Additional Details around this... */,
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'l1fs4i3p' /* Additional Details around this... */,
                                ),
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ),
                            ),
