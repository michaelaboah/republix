...
import 'candidate_post_model.dart';
export 'candidate_post_model.dart';

class CandidatePostWidget extends StatefulWidget {
  const CandidatePostWidget({super.key});

  @override
  State<CandidatePostWidget> createState() => _CandidatePostWidgetState();
}

class _CandidatePostWidgetState extends State<CandidatePostWidget>
    with TickerProviderStateMixin {
  late CandidatePostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CandidatePostModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'dlyk2sys' /* Take the pulse directly from y... */,
                      ),
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CANDIDATE_POST_COMP_ADD_IMAGE_BTN_ON_TAP');
                                logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              '18pwrz4z' /* Description */,
                            ),
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintText: FFLocalizations.of(context).getText(
                              '8rwmw8q5' /* We the people... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CANDIDATE_POST_COMP_CANCEL_BTN_ON_TAP');
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CANDIDATE_POST_COMP_POST_BTN_ON_TAP');
                              ...
                              await PostsRecord.collection.doc().set({
                                ...createPostsRecordData(
                                  ...
                                  candidateRef:
                                      currentUserDocument?.candidateRef,
                                ),
                                ...mapToFirestore(
                                  {
