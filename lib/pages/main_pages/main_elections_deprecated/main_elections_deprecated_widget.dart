...
import 'main_elections_deprecated_model.dart';
export 'main_elections_deprecated_model.dart';

class MainElectionsDeprecatedWidget extends StatefulWidget {
  const MainElectionsDeprecatedWidget({super.key});

  @override
  State<MainElectionsDeprecatedWidget> createState() =>
      _MainElectionsDeprecatedWidgetState();
}

class _MainElectionsDeprecatedWidgetState
    extends State<MainElectionsDeprecatedWidget> with TickerProviderStateMixin {
  late MainElectionsDeprecatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainElectionsDeprecatedModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_ElectionsDeprecated'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MAIN_ELECTIONS_DEPRECATED_Main_Elections');
      logFirebaseEvent('Main_ElectionsDeprecated_backend_call');
      ...
      if ((_model.civicResponse?.succeeded ?? true)) {
        logFirebaseEvent('Main_ElectionsDeprecated_custom_action');
        unawaited(
          () async {
                                  ...
                                  children: [
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MAIN_ELECTIONS_DEPRECATED_mapMarkerAlt_I');
                                          logFirebaseEvent(
                                              ...
                                              return ListView.separated(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'MAIN_ELECTIONS_DEPRECATED_Container_ie1f');
                                                      logFirebaseEvent(
                                              ...
                                              return GridView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'MAIN_ELECTIONS_DEPRECATED_Container_n1u6');
                                                    },
                                                    child: Container(
                                                      width: double.infinity,
                                                      height: 65.0,
                                                              ...
                                                              itemBuilder: (context,
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'MAIN_ELECTIONS_DEPRECATED_Container_d6vo');
                                                                    logFirebaseEvent(
                                                                        'Container_navigate_to');
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'MAIN_ELECTIONS_DEPRECATED_Container_nslk');
                                                                  logFirebaseEvent(
                                                                      'Container_navigate_to');
