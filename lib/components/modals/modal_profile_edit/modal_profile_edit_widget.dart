              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'gp63t4wk' /* Below are your profile details */,
                      ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '3jzvt6q5' /* The email associated with this... */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '8of7xk52' /* casper@ghostbusters.com */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge,
                                    )),
